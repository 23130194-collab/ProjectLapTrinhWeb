...
<head>
    ...
    <style>
        /* Tối ưu hiển thị khi không có thanh lọc bên trái */
        .product-grid {
        ...
        <c:forEach items="${productList}" var="p">
            <div class="product-card">
                ...
                <a href="product-detail?id=${p.id}" class="product-link">
                    <img src="${p.image.startsWith('http') ? p.image : pageContext.request.contextPath.concat('/').concat(p.image)}" class="product-image" alt="${p.name}">
