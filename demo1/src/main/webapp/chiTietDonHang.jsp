...
<header class="header">
    <div class="header-container">
        <a href="${contextPath}/home.jsp" class="logo">
    ...
    <div class="main">
        <aside class="side">
            <nav class="menu">
                ...
                <a href="sanPhamYeuThich.html" class="menu-item">
                    <i class="fa-regular fa-heart icon"></i> <span class="label">Sản phẩm yêu thích</span>
                </a>
                <a href="thongTinTaiKhoan.jsp" class="menu-item">
                    <i class="fa-regular fa-user icon"></i> <span class="label">Thông tin tài khoản</span>
                </a>
                <a href="${contextPath}/logout" class="menu-item">
                    <i class="fa-solid fa-right-from-bracket icon"></i> <span class="label">Đăng xuất</span>
                </a>
            </nav>
        </aside>
                    ...
                    <div class="order-details-view">
                        ...
                        <div class="card detail-card">
                            ...
                            <div class="payment-group">
                                ...
                                <div class="payment-line-new"><span>Tổng tiền hàng:</span><strong><fmt:formatNumber value="${order.subprice}" type="currency" currencySymbol="₫"/></strong></div>
                                <div class="payment-line-new"><span>Giảm giá:</span><strong style="color:var(--accent-dark);">-<fmt:formatNumber value="${order.discountAmount}" type="currency" currencySymbol="₫"/></strong></div>
                            ...
                            <div class="payment-group">
                                ...
                                <div class="payment-line-new final"><span>Tổng số tiền:</span><strong class="final-price"><fmt:formatNumber value="${order.totalAmount}" type="currency" currencySymbol="₫"/></strong></div>
                                <div class="payment-line-new final"><span>Tổng số tiền đã thanh toán:</span><strong class="final-price"><fmt:formatNumber value="${order.totalAmount}" type="currency" currencySymbol="₫"/></strong></div>
                            </div>
                        </div>
                        <c:if test="${order.orderStatus eq 'Chờ xác nhận'}">
                            <div class="action-footer">
                                <a href="#confirm-cancel-modal" class="btn-cancel-order">
                                    Hủy đơn hàng
                                </a>
                            </div>
                        </c:if>
                        ...
                        <div id="confirm-cancel-modal" class="modal-overlay">
                            <div class="modal-card">
                                ...
                                <p class="modal-text">Bạn có chắc chắn muốn hủy đơn hàng <strong>#${order.orderCode}</strong>? Hành động này không thể hoàn tác.</p>
                                <div class="modal-actions">
                                    <a href="#" class="modal-btn btn-no">Quay lại</a>

                                    <form action="${contextPath}/order-detail" method="post" style="margin: 0;">
                                        <input type="hidden" name="action" value="cancel">
                                        <input type="hidden" name="id" value="${order.id}">
                                        <button type="submit" class="modal-btn btn-yes">Xác nhận hủy</button>
                                    </form>
                                </div>
                            </div>
                        </div>
